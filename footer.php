<footer class="footer">
        ...
        <div class="githubbox">
            <div>
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                     ...
                     width="35.579px" height="31.774px" viewBox="0 0 30.579 30.774">
                    <path fill-rule="evenodd" clip-rule="evenodd" fill="#191717" d="M16.289,0C7.294,0,0,7.293,0,16.29
	...
	c0,0.436,0.293,0.941,1.12,0.783c6.468-2.158,11.13-8.26,11.13-15.455C32.579,7.293,25.286,0,16.289,0z"/>
            ...
            Star and fork minos on <a href="https://github.com/JacobSchwartzSoerensen/minos">Github!</a>
        </div>
</footer>